...
func init() {
	...
	issueListCmd.Flags().StringP("milestone", "m", "", "Filter by milestone")
...
func issueList(cmd *cobra.Command, args []string) error {
	...
	listResult, err := api.IssueList(apiClient, baseRepo, state, labels, assignee, limit, author, milestone)
	if err != nil {
		return err
	}
	...
	cmd.Flags().Visit(func(f *pflag.Flag) {
		switch f.Name {
		case "state", "label", "assignee", "author", "milestone":
			hasFilters = true
		}
	})
